...
- Name: sales-workflow.spec.ts >> Sales workflow >> clicking + beyond stock shows error and keeps quantity
- Location: tests/sales-workflow.spec.ts:101:7
    ...
    - generic [ref=e210]:
      ...
      - generic [ref=e233]:
        - generic [ref=e234]:
          ...
          - generic [ref=e244]:
            - generic [ref=e245]:
              - generic [ref=e246]: Maglia paricollo
              - code [ref=e247]: MGLPRCC739-BLU-SMA / Small
            - generic [ref=e248]:
              ...
              - button [active] [ref=e252] [cursor=pointer]:
                - img [ref=e253]
            - generic [ref=e254]:
              - generic [ref=e255]: 240,00 €
              - text: (120,00 € × 2)
            - button [ref=e256] [cursor=pointer]:
              - img [ref=e257]
          - generic [ref=e260]:
            - generic [ref=e261]:
              - generic [ref=e262]: Subtotale
              - strong [ref=e263]: 240,00 €
            - generic [ref=e264]:
              - generic [ref=e265]: IVA
              - spinbutton [ref=e267]: "0"
            - generic [ref=e268]:
              - generic [ref=e269]: Sconto Ordine
              - spinbutton [ref=e271]: "0"
            - generic [ref=e272]:
              - generic [ref=e273]: Totale
              - strong [ref=e274]: 240,00 €
          - generic [ref=e276]:
            - generic [ref=e277]: Note
            - textbox "Note vendita..." [ref=e278]
        - generic [ref=e279]:
          - generic [ref=e281]: Negozio
          - combobox [ref=e283] [cursor=pointer]:
            - option "Seleziona negozio" [disabled]
            - option "Seleziona negozio"
            - option "Acme Corporation - Main Store" [selected]
          - generic [ref=e285]: Clienti
          - generic [ref=e286]:
            - textbox "Cerca clienti..." [ref=e287]
            - button "Gino Paoli gino@gmail.com" [ref=e289] [cursor=pointer]:
              - generic [ref=e290]: Gino Paoli
              - generic [ref=e291]: gino@gmail.com
          - button "Procedi al Pagamento · 240,00 €" [ref=e293] [cursor=pointer]:
            - img [ref=e294]
            - text: Procedi al Pagamento · 240,00 €
```
...
> 111 |     await expect(page.locator('.alert--error')).toBeVisible();
  ...
  173 |     await expect(page.locator('.balance--ok')).toBeVisible();
  174 |     const completeBtn = page.locator('button:has-text("Completa Vendita")');
  175 |     await expect(completeBtn).toBeEnabled();
  176 |   });
  177 | 
  178 |   test('GiftCard payment method submits correctly and creates sale', async ({ page }) => {
  179 |     await selectStore(page);
  180 |     await searchAndAddProduct(page, 'maglia', 'NER-MED');
  181 | 
  182 |     await page.evaluate(() => {
  183 |       const btn = [...document.querySelectorAll('button')].find((b) =>
  184 |         b.textContent?.includes('Pagamento'),
  185 |       ) as HTMLButtonElement;
  186 |       btn?.click();
  187 |     });
  188 |     await page.waitForSelector('.payment-row select');
  189 | 
  190 |     // Switch to GiftCard
  191 |     await page.locator('.payment-row select').selectOption('GiftCard');
  192 | 
  193 |     await page.evaluate(() => {
  194 |       const btn = [...document.querySelectorAll('button')].find(
  195 |         (b) => b.textContent?.trim() === 'Completa Vendita',
  196 |       ) as HTMLButtonElement;
  197 |       btn?.click();
  198 |     });
  199 | 
  200 |     // Should redirect to sale detail
  201 |     await page.waitForURL(/\/pos\/sales\/[0-9a-f-]{36}/, { timeout: 10_000 });
  202 |     expect(page.url()).toMatch(/\/pos\/sales\/[0-9a-f-]{36}/);
  203 |   });
  204 | 
  205 |   test('completed sale detail shows correct payment method label', async ({ page }) => {
  206 |     await selectStore(page);
  207 |     await searchAndAddProduct(page, 'maglia', 'NER-MED');
  208 | 
  209 |     await page.evaluate(() => {
  210 |       (
  211 |         [...document.querySelectorAll('button')].find((b) =>
```